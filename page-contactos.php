			...
			<div class="col-xs-12 col-md-6 contenidoInterno__Contenido">
				<div class="BotonesContactos">
					<div class="BotonContacto BotonesContactos__Email">
						<div class="BotonContacto_Icono BotonesContactos__Email__Icono"><img src="<?php echo get_template_directory_uri();?>/img/email.png" class="img-fluid" alt="email"></div>
					...
					<div class="BotonContacto BotonesContactos__Telefono">
						<div class="BotonContacto_Icono BotonesContactos__Telefono__Icono"><img src="<?php echo get_template_directory_uri();?>/img/telefono.png" class="img-fluid" alt="Telefono"></div>
					...
					<div class="BotonContacto BotonesContactos__Direccion">
						<div class="BotonContacto_Icono BotonesContactos__Direccion__Icono"><img src="<?php echo get_template_directory_uri();?>/img/direccion.png" class="img-fluid" alt="Direccion"></div>
